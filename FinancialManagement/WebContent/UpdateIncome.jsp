...
<body>
	...
	<form action = "UpdateIncome" method = "post">
		...
		<fieldset class="form-group">
		Remarks <br> <input type = "text" name = "remarks" value ="<%= remarks %>"> <br>
		</fieldset>
		
		<button type ="submit" name = "submit" onClick = "return validate();" class="btn btn-primary">Update Income</button>
