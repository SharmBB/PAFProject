...
<body>
	...
	<form name = "insert" action = "insertExpense" method = "post">
		...
		<fieldset class="form-group">
		Quantity <br> <input type = "number" name = "quantity" onkeypress="isInputNumber(event)"> <br>
		</fieldset>
		...
		<button type ="submit" name = "submit" onClick = "return validate();" class="btn btn-success">Add Expense</button>
